...
#define All_VALID_PAGE 0x0000000000000000ULL
	...
	*/
	...
	public:
		...
		void Read_transaction_issued(const NVM::FlashMemory::Physical_Page_Address& page_address, int is_rr);//Updates the block bookkeeping record JY_Modified_RD
