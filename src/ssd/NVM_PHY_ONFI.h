...
namespace SSD_Components
{
	...
	public:
		...
		virtual void Set_metadata(flash_channel_ID_type channel_id, flash_chip_ID_type chip_id, flash_die_ID_type die_id, flash_plane_ID_type plane_id, flash_block_ID_type block_id, flash_page_ID_type page_id, LPA_type lpa) = 0; //JY_Modified
		...
		void public_broadcastTransactionServicedSignal(NVM_Transaction_Flash* transaction);
	protected:
